...
{
    /*
     * TODO 1: Create the classes as outlined on the UML Diagram
     *  found here: https://codecishk.com/index.php/topic/inheritance/.
     *  Add all of them under the Lab3 folder.
     */
